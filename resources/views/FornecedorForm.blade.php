  ...
  <body class="layout">
    ...
    <div class="content">
      ...
      <form action="{{ $route}}" method="POST">
        ...
        value="@if (!empty(old('contato'))) {{ old('contato') }} @elseif(!empty($fornecedor->contato)) {{ $fornecedor->contato }} @else {{ '' }} @endif" /><br>

        <label>Assunto</label><br>
        <input type="text" class="form-control" name="assunto"
        value="@if (!empty(old('assunto'))) {{ old('assunto') }} @elseif(!empty($fornecedor->assunto)) {{ $fornecedor->assunto }} @else {{ '' }} @endif" /><br>

        <label>Data</label><br>
        <input type="date" class="form-control" name="data"
        value="@if (!empty(old('data'))) {{ old('data') }} @elseif(!empty($fornecedor->data)) {{ $fornecedor->data }} @else {{ '' }} @endif" /><br>
